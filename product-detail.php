...
if(isset($_GET['id'])){
	...
	$fetchAllCategory = mysqli_query($con,"SELECT * FROM product WHERE id = '$id'");
...
<form action="shoping-cart.php" method="post">
	...
	<input type="hidden" name="p_image" value="<?php echo $data['p_image'] ?>">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="Admin_Dashboard/Images/<?php echo $data['p_image'] ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="Admin_Dashboard/Images/<?php echo $data['p_image'] ?>" alt="IMG-PRODUCT">
						...
						<div class="p-t-33">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<button type="submit" name="addCart" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
										Add to cart
									</button>
								</div>
							</div>	
